...
<body>
    ...
    <div class="header-background">
        <div class="header-content">
            ...
            <h6>Style and performance are equally important when choosing a ceiling fan. One should not be sacrificed
                for the other.</h6>
        </div>
    </div>
        ...
        <div class="row welcome text-center">
            ...
            <div class="container-fluid padding py-3">
                <div class="row padding">
                    <div class="col-md-12 col-lg-6">
                        ...
                        <p>Where you will install your fan is the first step in selecting the right fan for your space.
                        </p>
                        ...
                        <div class="row text-center padding py-5">
                            <div class="col-xs-12 col-sm-6 col-md-4 ">
                                <img src="https://fanimation.com/wp-content/uploads/2019/12/icon-location-dry.png"
                                    alt="">
                                <h6>Dry, indoor location</h6>
                                <p>Choose from any of our fans: dry, damp or wet rated.</p>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <img src="https://fanimation.com/wp-content/uploads/2019/12/icon-location-damp.png"
                                    alt="">
                                <h6>Outdoor covered or high-humidity indoor location</h6>
                                <p>Choose from our damp or wet rated fans.</p>
                            </div>
                            <div class="col-sm-12 col-md-4">
                                <img src="https://fanimation.com/wp-content/uploads/2019/12/icon-location-wet.png"
                                    alt="">
            ...
            <div class="container-fluid">
                <div class="jumbotron padding">
                    <div class="col-12">
                        <h5>SIZE MATTERS</h5>
                        <h6>The size of your room can help determine the size of your fan, identified by blade sweep.
                        </h6>
                        <h6>The following are general guidelines; however, scale is a personal preference.</h6>
                        <p> - Large diameter fans can go in both small rooms and larger rooms. It’s all in the look you
                            desire.</p>
                    ...
                    <div class="row text-center padding py-5">
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <h6>Small room</h6>
                            <img src="https://fanimation.com/wp-content/uploads/2019/12/choose-fit-small-fan.png"
                                alt="">
                            <p>52 in. or smaller</p>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4 ">
                            <h6>Large room</h6>
                            <img src="https://fanimation.com/wp-content/uploads/2019/12/choose-fit-medium-fan.png"
                                alt="">
                            <p>52 in. or larger</p>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <h6>Great room</h6>
                            <img src="https://fanimation.com/wp-content/uploads/2019/12/choose-fit-large-fan.png"
                                alt="">
                            <p>60 in. or larger</p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 py-5">
                        ...
                        <img src="https://fanimation.com/wp-content/uploads/2019/12/choose-fit-downrod-length-rev2.png"
                            alt="">
                    ...
                    <div class="col-12 py-5">
                        ...
                        <img src="https://fanimation.com/wp-content/uploads/2019/12/choose-fit-slope-pitch-rev1.png"
                            alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid padding py-5">
                <div class="row welcome text-center">
                    <div class="col-12">
                        ...
                        <p>As you choose your fan, identify the features that matter to you. Use the Features Legend
                            below to understand the Features icons.</p>
