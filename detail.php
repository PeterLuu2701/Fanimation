        ...
        <div class="container">
                        ...
                        <section class="product">
                            ...
                            <div class="product-container">
                                <div class="product-card">
                                    <img src="https://fanimation.com/wp-content/uploads/2019/12/triaire_mad8514.jpg"
            ...
            <div class="row">
                ...
                <div class="triaire_text col-md-6 col-sm-6">
                    <h1>TriAire™</h1>
                    <p>The TriAire Custom by Fanimation fits any style in any location. With eight different blade
                        sweeps in multiple finishes, you can create the TriAire Custom that fits your space. This
                        wet
                        rated ceiling fan has a 31 speed DC motor. Light kit, blades and motor sold separately.</p>
                    <p>
            ...
            <div class="row">
                ...
                <div class="product_specs4 col-md-3 col-sm-6">
                    <p><img width="40" height="40"
                            src="https://fanimation.com/wp-content/uploads/2019/12/icon-fan-speed-40x40.png"
                            class="vc_single_image-img attachment-full" alt="" loading="lazy"
                            title="icon-fan-speed-40x40"></p>
                    <p><b>FAN SPEED</b></p>
                    <p>16 speed DC with reverse</p>
                    <p>switch on remote</p>
                </div>
                <div class="product_specs4 col-md-3 col-sm-6">
                    <p><img width="40" height="40" src="https://fanimation.com/wp-content/uploads/2019/12/wet_icon.png"
                            class="vc_single_image-img attachment-full" alt="" loading="lazy" title="wet_icon"></p>
                    <p><b>WET RATED</b></p>
                    <p>Indoor/Outdoor</p>
                </div>
                <div class="product_specs4 col-md-3 col-sm-6">
                    <p><img width="40" height="40"
                            src="https://fanimation.com/wp-content/uploads/2019/12/icon-mixmatch-40x40.png"
                            class="vc_single_image-img attachment-full" alt="" loading="lazy"
                            title="icon-mixmatch-40x40"></p>
                    <p><b>MIX & MATCH</b></p>
                    <p>Components sold</p>
                    <p>separately</p>
                </div>
                <div class="product_specs4 col-md-3 col-sm-6">
                    <p><img width="40" height="40"
                            src="https://fanimation.com/wp-content/uploads/2019/12/icon-blades.png"
                            class="vc_single_image-img attachment-full" alt="" loading="lazy" title="icon-blades">
                    </p>
                    <p><b>BLADES</b></p>
                    <p><i>Available</i></p>
            ...
            <div class="row">
                <div class="product_specs4 col-md-4 col-sm-6">
                    <p><img width="40" height="40"
                            src="https://fanimation.com/wp-content/uploads/2019/12/icon-control3-40x40.png"
                            class="vc_single_image-img attachment-full" alt="" loading="lazy"
                            title="icon-control3-40x40"></p>
                    <p><b>CONTROLS</b></p>
                    <p><i>Included:</i></p>
                ...
                <div class="product_specs4 col-md-4 col-sm-6">
                    <p><img width="40" height="40"
                            src="https://fanimation.com/wp-content/uploads/2019/12/light_adaptable.png"
                            class="vc_single_image-img attachment-full" alt="" loading="lazy"
                            title="icon-control3-40x40"></p>
                    <p><b>LIGHTING</b></p>
                    <p><i>Available</i></p>
                ...
                <div class="product_specs4 col-md-4 col-sm-6">
                    <p><img width="40" height="40"
                            src="https://fanimation.com/wp-content/uploads/2019/12/icon-accessories-40x40.png"
                            class="vc_single_image-img attachment-full" alt="" loading="lazy"
                            title="icon-accessories-40x40"></p>
                    <p><b>ACCESSORIES</b></p>
                    <p><i>Included:</i></p>
                    <p>4.5" downrod</p>
                    </br>
                    <p><i>Available:</i></p>
                    <p>DR1-** – longer downrods</br>DR1SS-** – stainless steel downrods</br>SCB1-52 – sloped ceiling
                        kit</br>CCK8002** – close to ceiling kit</p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <img width="300" height="300"
                        src="https://fanimation.com/wp-content/uploads/catalog/product/wfr-300x300.jpg"
                        alt="fanSync DC WiFi" title="fanSync DC WiFi">
                    <p>fanSync DC WiFi</p>
                </div>
                <div class="col-md-3 col-sm-6">
                    <img width="300" height="300"
                        src="https://fanimation.com/wp-content/uploads/catalog/product/bpw851448dww-300x300.jpg"
                        alt="BPW8514-48*** – 48″ TriAire Custom Blade Set"
                        title="BPW8514-48*** – 48″ TriAire Custom Blade Set">
                    <p>BPW8514-48*** – 48″ TriAire Custom Blade Set</p>
                </div>
                <div class="col-md-3 col-sm-6 ">
                    <img width="300" height="300"
                        src="https://fanimation.com/wp-content/uploads/catalog/product/tw206d-300x300.jpg" alt="TW206D"
                        title="TW206D">
                    <p>TW206D</p>
                </div>
                <div class="col-md-3 col-sm-6">
                    <img width="300" height="300"
                        src="https://fanimation.com/wp-content/uploads/catalog/product/lk8514dzw-300x300.jpg"
                        alt="TriAire Custom Light Kit" title="TriAire Custom Light Kit">
            ...
            <div class="jumbotron">
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
                    ...
                    <p>Fanimation fans are the perfect fusion of beauty and functionality. With designs for every
                        style
                        and technology-driven controls for your convenience, Fanimation fans inspire your home. They
                        integrate into any space and allow you to make a statement that is all your own.</p>
                </div>
