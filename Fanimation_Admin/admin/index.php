...
$route = !empty($_GET['r']) ? $_GET['r'] : 'main';
$action = !empty($_GET['a']) ? $_GET['a'] : 'list';

$file = 'modules/'.$route.'/'.$action.'.php';
$file404 = 'modules/main/404.php'
?>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="index.php">
            <i class="fa fa-calendar"></i> <span>Homepage</span>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?r=product"><i class="fa fa-circle-o"></i> Product List</a></li>
