                            ...
                            <div class="product-size">
                                <a href="" data-product_num="5" class="product-size size-5">
                                    <svg viewBox="0 0 16 16" widht="100%" height="100%">
                                        <path d="M 4.769 3.385 c 0 0.762 -0.623 1.385 -1.385 1.385 S 2 4.146 2 3.385 S 2.623 2 3.385 2 s 1.384 0.623 1.384 1.385 Z M 9.385 3.385 c 0 0.762 -0.623 1.385 -1.385 1.385 s -1.385 -0.624 -1.385 -1.385 S 7.238 2 8 2 s 1.385 0.623 1.385 1.385 Z M 4.769 8 c 0 0.762 -0.623 1.385 -1.385 1.385 S 2 8.762 2 8 s 0.623 -1.385 1.385 -1.385 S 4.769 7.238 4.769 8 Z M 9.385 8 c 0 0.762 -0.623 1.385 -1.385 1.385 S 6.615 8.762 6.615 8 S 7.238 6.615 8 6.615 S 9.385 7.238 9.385 8 Z M 4.769 12.615 c 0 0.762 -0.623 1.385 -1.384 1.385 S 2 13.377 2 12.615 s 0.623 -1.385 1.385 -1.385 s 1.384 0.624 1.384 1.385 Z M 9.385 12.615 C 9.385 13.377 8.762 14 8 14 s -1.385 -0.623 -1.385 -1.385 s 0.623 -1.384 1.385 -1.384 s 1.385 0.623 1.385 1.384 Z M 14 3.385 c 0 0.762 -0.623 1.385 -1.385 1.385 s -1.385 -0.623 -1.385 -1.385 S 11.854 2 12.615 2 C 13.377 2 14 2.623 14 3.385 Z M 14 8 c 0 0.762 -0.623 1.385 -1.385 1.385 S 11.231 8.762 11.231 8 s 0.623 -1.385 1.385 -1.385 C 13.377 6.615 14 7.238 14 8 Z M 14 12.615 c 0 0.762 -0.623 1.385 -1.385 1.385 s -1.385 -0.623 -1.385 -1.385 s 0.623 -1.385 1.385 -1.385 A 1.39 1.39 0 0 1 14 12.615 Z"></path>
                                    </svg>
                                </a>
                                <a href="" data-product_num="4" class="product-size size-4">
                                    <svg viewBox="0 0 16 16" widht="100%" height="100%">
                                        <path d="M 7 4.5 C 7 5.875 5.875 7 4.5 7 S 2 5.875 2 4.5 S 3.125 2 4.5 2 S 7 3.125 7 4.5 Z M 14 4.5 C 14 5.875 12.875 7 11.5 7 S 9 5.875 9 4.5 S 10.125 2 11.5 2 S 14 3.125 14 4.5 Z M 7 11.5 C 7 12.875 5.875 14 4.5 14 S 2 12.875 2 11.5 S 3.125 9 4.5 9 S 7 10.125 7 11.5 Z M 14 11.5 c 0 1.375 -1.125 2.5 -2.5 2.5 S 9 12.875 9 11.5 S 10.125 9 11.5 9 s 2.5 1.125 2.5 2.5 Z"></path>
                                    </svg>
                                </a>
                                <a href="" data-product_num="3" class="product-size size-3">
                                    <svg viewBox="0 0 16 16" widht="100%" height="100%">
                                        <path d="M 14 8 c 0 3.3 -2.7 6 -6 6 s -6 -2.7 -6 -6 s 2.7 -6 6 -6 s 6 2.7 6 6 Z"></path>
                                    </svg>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="product-item col-md-3 col-sm-6">
                        <div class="product-top">
                            <a href="" class="product-thumb">
                                <img src="./img/223.jpg" style="height: 100%;width:100%"alt="">
                            </a>
